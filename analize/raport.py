...
from Allegro_scanner.data.select import select_all_offers
from Allegro_scanner.data.select import select_raports_by_offer_id
from Allegro_scanner.data.select import select_user_raports
